...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication() {
        ...
        builder.UseApplication<ClinicManagerWindowsFormsApplication>();
        builder.Modules
            .AddConditionalAppearance()
            .AddValidation(options => {
                options.AllowValidationDetailsAccess = false;
            })
            .Add<ClinicManager.Module.ClinicManagerModule>()
            .Add<ClinicManagerWinModule>();
    ...
    XafApplication IDesignTimeApplicationFactory.Create() {
        DevExpress.ExpressApp.Security.ClientServer.MiddleTierClientSecurity.DesignModeUserType = typeof(ClinicManager.Module.BusinessObjects.ApplicationUser);
